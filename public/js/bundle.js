...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc, index) {
    ...
    if (!loc.coordinates || loc.coordinates.length !== 2) {
      console.warn("Invalid coordinates for location ".concat(index, ":"), loc);
      return;
    }
    ...
    if (typeof lat !== 'number' || typeof lng !== 'number' || lat < -90 || lat > 90 || lng < -180 || lng > 180) {
      console.warn("Invalid lat/lng values for location ".concat(index, ":"), {
        lat: lat,
        lng: lng
      });
      return;
    ...
    var marker = L.marker([lat, lng]).addTo(map).bindPopup("<p>Day ".concat(loc.day || index + 1, ": ").concat(loc.description || 'No description', "</p>"));
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " has been successfully updated"));
          }
          _context.n = 3;
          break;
        case 2:
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    var session, PAYSTACK_PUBLIC_KEY, handler, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
        ...
        case 1:
          ...
          PAYSTACK_PUBLIC_KEY = 'pk_test_e3eb58bd9657b232940c549f93546960b8a6df35'; // 2) Open Paystack inline checkout
          handler = PaystackPop.setup({
            key: PAYSTACK_PUBLIC_KEY,
            access_code: session.data.access_code,
            // Use this to link to the server-initiazed transactionli
            email: session.data.email,
            amount: session.data.amount,
            callback: function callback(response) {
              console.log('paystack res', response);
              if (response.status === 'success') {
                (0, _alert.showAlert)('success', 'Payment successful!');
                verifyPayment(response.reference, tourId, session.data.userId);
              }
            },
            onClose: function onClose() {
              (0, _alert.showAlert)('error', 'Payment cancelled');
            }
          });
          handler.openIframe();
          _context.n = 3;
        ...
        case 2:
          ...
          (0, _alert.showAlert)('error', 'An error occured');
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
...
var verifyPayment = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(reference, tourId, userId) {
    var _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
        ...
        case 2:
          ...
          (0, _alert.showAlert)('error', 'Payment verification failed');
        case 3:
          return _context2.a(2);
      }
    }, _callee2, null, [[0, 2]]);
  }));
  return function verifyPayment(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
...
var submitReview = exports.submitReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(rating, review, tour) {
    var res, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            tour = reviewForm.dataset.tourId;
            console.log({
              rating: rating,
              review: review,
              tour: tour
            ...
            _context.n = 1;
            return (0, _review.submitReview)(rating, review, tour);
          case 1:
            highlightStars(0);
            ratingInput.value = '';
            reviewText.value = '';
