...
// //If we have one field accepting just one file
// upload.single('images')

// //If we have one fields accepting multiple files (with the same field name)
...
exports.getAgregrate = catchAsync(async (req, res, next) => {
...
exports.getToursWithin = catchAsync(async (req, res, next) => {
  ...
  if (!lat || !lng) {
    new AppError(
      'Please specify the latitude and longitude in this format lat, lng',
      400
    );
  }
